...
<Project Type="Project" LVVersion="22308000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="DataQ_OHT" Type="Folder">
			<Item Name="Logging" Type="Folder">
				<Item Name="Create Log File.vi" Type="VI" URL="../Common/DataQ_OHT/Logging/Create Log File.vi"/>
				<Item Name="Log Data to File.vi" Type="VI" URL="../Common/DataQ_OHT/Logging/Log Data to File.vi"/>
			</Item>
			<Item Name="AddEventsLogToQ_Wrapper.vi" Type="VI" URL="../Common/DataQ_OHT/AddEventsLogToQ_Wrapper.vi"/>
			<Item Name="Create EventsLog Q.vi" Type="VI" URL="../Common/DataQ_OHT/Create EventsLog Q.vi"/>
			<Item Name="Create LogMeasData Q.vi" Type="VI" URL="../Common/DataQ_OHT/Create LogMeasData Q.vi"/>
			<Item Name="Create MeasData Q.vi" Type="VI" URL="../Common/DataQ_OHT/Create MeasData Q.vi"/>
			<Item Name="Destroy LogMeasData Q.vi" Type="VI" URL="../Common/DataQ_OHT/Destroy LogMeasData Q.vi"/>
			<Item Name="Destroy MeasData Q.vi" Type="VI" URL="../Common/DataQ_OHT/Destroy MeasData Q.vi"/>
			<Item Name="Flush LogMeasData Q.vi" Type="VI" URL="../Common/DataQ_OHT/Flush LogMeasData Q.vi"/>
			<Item Name="GBL DataQ Ref.vi" Type="VI" URL="../Common/DataQ_OHT/GBL DataQ Ref.vi"/>
			<Item Name="Get All LogData from Q.vi" Type="VI" URL="../Common/DataQ_OHT/Get All LogData from Q.vi"/>
			<Item Name="Get All LogMeasData from Q.vi" Type="VI" URL="../Common/DataQ_OHT/Get All LogMeasData from Q.vi"/>
			<Item Name="Get MeasData from Q.vi" Type="VI" URL="../Common/DataQ_OHT/Get MeasData from Q.vi"/>
			<Item Name="Get MeasData Q and Insert Logging Data.vi" Type="VI" URL="../Common/DataQ_OHT/Get MeasData Q and Insert Logging Data.vi"/>
			<Item Name="Insert LogData in Q.vi" Type="VI" URL="../Common/DataQ_OHT/Insert LogData in Q.vi"/>
			<Item Name="Insert LogMeasData in Q.vi" Type="VI" URL="../Common/DataQ_OHT/Insert LogMeasData in Q.vi"/>
			<Item Name="TD EventLogData--cluster.ctl" Type="VI" URL="../Common/DataQ_OHT/TD EventLogData--cluster.ctl"/>
			<Item Name="TD MeasData QRef.ctl" Type="VI" URL="../Common/DataQ_OHT/TD MeasData QRef.ctl"/>
			<Item Name="TD MeasData--cluster.ctl" Type="VI" URL="../Common/DataQ_OHT/TD MeasData--cluster.ctl"/>
			<Item Name="Update DIs in MeasDataQ.vi" Type="VI" URL="../Common/DataQ_OHT/Update DIs in MeasDataQ.vi"/>
		</Item>
		<Item Name="DataTypes" Type="Folder">
			<Item Name="Custom" Type="Folder">
				<Item Name="SetHomeButton.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/Custom/SetHomeButton.ctl"/>
			</Item>
			<Item Name="AI IONames--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/AI IONames--cluster.ctl"/>
			<Item Name="AO IONames--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/AO IONames--cluster.ctl"/>
			<Item Name="DI IONames--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/DI IONames--cluster.ctl"/>
			<Item Name="DO IONames--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/DO IONames--cluster.ctl"/>
			<Item Name="GBL System.vi" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/GBL System.vi"/>
			<Item Name="JogSettings_Motor--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/JogSettings_Motor--cluster.ctl"/>
			<Item Name="MotionScaleFactors--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/MotionScaleFactors--cluster.ctl"/>
			<Item Name="MotorSyncFGVAction--enum.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/MotorSyncFGVAction--enum.ctl"/>
			<Item Name="placeholder.txt" Type="Document" URL="../Classes/DAQWFE/LV_Source/DataTypes/placeholder.txt"/>
			<Item Name="SessionSettings--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/SessionSettings--cluster.ctl"/>
			<Item Name="Startup INI Data--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/Startup INI Data--cluster.ctl"/>
			<Item Name="TD LaunchData--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/TD LaunchData--cluster.ctl"/>
			<Item Name="TD LaunchState--enum.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/TD LaunchState--enum.ctl"/>
			<Item Name="TD Pathnames--cluster.ctl" Type="VI" URL="../Classes/DAQWFE/LV_Source/DataTypes/TD Pathnames--cluster.ctl"/>
		...
		<Item Name="Controls" Type="Folder">
			...
			<Item Name="PrepurgeScanTracking--Cluster.ctl" Type="VI" URL="../Classes/TopLevel/Typedefs/PrepurgeScanTracking--Cluster.ctl"/>
			<Item Name="PrintCmdParameters--Cluster.ctl" Type="VI" URL="../Classes/GIS Printer/Typedefs/PrintCmdParameters--Cluster.ctl"/>
			<Item Name="IdlePrintCmdParameters--Cluster.ctl" Type="VI" URL="../Classes/GIS Printer/Typedefs/IdlePrintCmdParameters--Cluster.ctl"/>
			<Item Name="AbortEventData--Cluster.ctl" Type="VI" URL="../Classes/GIS Printer/Typedefs/AbortEventData--Cluster.ctl"/>
			<Item Name="Status_TopLevel--Cluster.ctl" Type="VI" URL="../Classes/Motor Controller/Typedefs/Status_TopLevel--Cluster.ctl"/>
			...
			<Item Name="printWeights--cluster.ctl" Type="VI" URL="../Classes/TopLevel/Typedefs/printWeights--cluster.ctl"/>
			<Item Name="Timer_Data--Cluster.ctl" Type="VI" URL="../Classes/DAQ_Common/DataTypes/Timer_Data--Cluster.ctl"/>
		</Item>
		...
		<Item Name="IO.lvclass" Type="LVClass" URL="../Classes/IO/IO.lvclass"/>
		<Item Name="Database.lvclass" Type="LVClass" URL="../Classes/Database/Database.lvclass"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Add States to Queue using MultiLine String (no vData input).vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/SMQ/Add States to Queue using MultiLine String (no vData input).vi"/>
				...
				<Item Name="Write Characters To File mod2KT.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/File/Write Characters To File mod2KT.vi"/>
				...
				<Item Name="TD Dynamic CVT DVR--ref.ctl" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/TD Dynamic CVT DVR--ref.ctl"/>
				<Item Name="Get ALL Dynamic CVT Data.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Get ALL Dynamic CVT Data.vi"/>
				<Item Name="Get Dynamic CVT Data.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Get Dynamic CVT Data.vi"/>
				<Item Name="Build Error Cluster_ModKT .vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Misc Utilities/Build Error Cluster_ModKT .vi"/>
				<Item Name="Delete Dynamic CVT Data.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Delete Dynamic CVT Data.vi"/>
				<Item Name="Delete ALL Dynamic CVT Data.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Delete ALL Dynamic CVT Data.vi"/>
				<Item Name="TD Dynamic CVT Variants--cluster.ctl" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/TD Dynamic CVT Variants--cluster.ctl"/>
				<Item Name="Get Dynamic CVT DictName.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Get Dynamic CVT DictName.vi"/>
				<Item Name="Destroy Dynamic CVT Reference.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Destroy Dynamic CVT Reference.vi"/>
				<Item Name="Qualified Name Array To Single String.vi" Type="VI" URL="/&lt;vilib&gt;/Utility/LVClass/Qualified Name Array To Single String.vi"/>
				<Item Name="Create Dynamic CVT Reference.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Create Dynamic CVT Reference.vi"/>
				<Item Name="Set Dynamic CVT Data.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Dynamic CVT API/Set Dynamic CVT Data.vi"/>
				...
				<Item Name="computed mean value DBL.vi" Type="VI" URL="/&lt;vilib&gt;/TELLC/Misc Utilities/computed mean value DBL.vi"/>
			...
			<Item Name="BuildSelectQuery.vi" Type="VI" URL="../Classes/Database/Util/BuildSelectQuery.vi"/>
			...
			<Item Name="TD GetSet ActionSelect--enum.ctl" Type="VI" URL="../Classes/DAQ_Common/DataTypes/TD GetSet ActionSelect--enum.ctl"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Digilens_IPLC" Type="EXE">
				...
				<Property Name="Bld_buildSpecDescription" Type="Str">V1.6.0.1 (CalibHeadNo)</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{9AE0F0D7-08B2-45CB-A2BB-E9871ADCBE1B}</Property>
				...
				<Property Name="Source[3].itemID" Type="Ref">/My Computer/TopLevel.lvclass/UIs/Digilens DLP Gen2 UI .vi</Property>
				<Property Name="Source[3].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[3].type" Type="Str">VI</Property>
				<Property Name="SourceCount" Type="Int">4</Property>
				<Property Name="TgtF_companyName" Type="Str">Wakefield Engineering</Property>
				<Property Name="TgtF_fileDescription" Type="Str">Digilens_IPLC V1.6.0.1 (CalibHeadNo)</Property>
